...
const IMAGE_TYPE_OPTIONS = [
  { value: 'openclaw', label: 'OpenClaw Desktop', defaultImage: 'ghcr.io/quseit/qagent-image/openclaw:latest' },
  ...
  { value: 'hermes', label: 'Hermes Runtime', defaultImage: 'ghcr.io/quseit/qagent-image/hermesagent:latest' },
